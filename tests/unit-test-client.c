...
#define IOBOX_IP "192.168.1.2"
#define IOBOX_PORT 502
#define SCANNER_IP "192.168.1.100"
...
#define TAB_REG_LEN 24
  ...
  // setup
  {
    ...
    modbus_set_error_recovery(mb_scanner, MODBUS_ERROR_RECOVERY_LINK |
                                              MODBUS_ERROR_RECOVERY_PROTOCOL);
    modbus_set_debug(mb_iobox, FALSE);
    modbus_set_response_timeout(mb_iobox, 5, 0);
    modbus_set_error_recovery(mb_iobox, MODBUS_ERROR_RECOVERY_LINK |
                                            MODBUS_ERROR_RECOVERY_PROTOCOL);
